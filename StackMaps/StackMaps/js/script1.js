...
var multipinpointdraw = false;
var firstoptiondraw = false;
var secondoptiondraw = false;

//DRAWS variables
var velocitystillrunning = false;
var mapcreated = false;
var map;
//-------------------------------------
//-------------------------------------
function pinPointWithInfoWindow() {

    var location = [
        ['1', 45.327063, 14.442176, 1],
        ['2', 45.492897, 15.555268, 1],
        ['3', 46.234, 16.555268, 2],
        ['4', 46.110, 16.55258, 2],
        ['5', 45.342, 15.234, 2]
    ];
     ...
     map = new google.maps.Map(document.getElementById('map'), {
        zoom: 10,
        center: new google.maps.LatLng(45.327063, 14.442176),
    ...
    for (var i = 0; i < location.length; i++) {
        ...
        })(marker, i)); //izgleda da je ovo closure
    }
...
var heatMapSpace = {
    ...
    createHeatMap: function() {
        ...
        this.array.push(heatmap);
        heatmap.setMap(map);
    },
    deleteHeatMap: function(){
        
        for (var k = 0; k < this.array.length; k++) {
            this.array[k].setMap(null);
...
function initializeVelocityAnimate() {
...
function moveMarker(mapz, marker1, latlng) {
    marker1.setPosition(latlng);
    mapz.panTo(latlng);
}

function startVelocity(mapu) {
    velocitystillrunning = true;
    var i;
